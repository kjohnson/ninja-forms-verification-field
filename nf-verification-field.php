<?php
/*
Plugin Name: Ninja Forms Verification Field
*/

function ninja_forms_register_field_verification(){
	$args = array(
		'name' => __( 'Verification', 'ninja-forms' ),
		'sidebar' => 'template_fields',
		'edit_function' => 'ninja_forms_field_verification_edit',
		'edit_options' => array(
			array(
				'type' => 'checkbox',
				'name' => 'datepicker',
		...
		'display_function' => 'ninja_forms_field_verification_display',
		'save_function' => '',
		...
		'pre_process' => 'ninja_forms_field_verification_pre_process',
...
function ninja_forms_field_verification_edit( $field_id, $data ){
...
function ninja_forms_field_verification_display( $field_id, $data, $form_id = '' ){
	global $current_user;
	...
	<input placeholder="confirme your value" id="_ninja_forms_field_<?php echo $field_id;?>" data-mask="<?php echo $mask;?>" data-input-limit="<?php echo $input_limit;?>" data-input-limit-type="<?php echo $input_limit_type;?>" data-input-limit-msg="<?php echo $input_limit_msg;?>" name="_ninja_forms_field_<?php echo $field_id;?>" type="text" class="<?php echo $field_class;?> <?php echo $mask_class;?>" rel="<?php echo $field_id;?>" />
	<?php

}

function ninja_forms_field_verification_pre_process( $field_id, $user_value ){
 ...
 * @return void
 */
function nf_field_verification_edit_sub_value( $field_id, $user_value ) {
	?>
 ...
 * @return void
 */
function nf_field_verification_sub_table_value( $field_id, $user_value ) {
